module Aviary.Birds where

import Control.Apply (class Apply, lift2)
import Control.Monad (class Bind, class Monad, (=<<), (>>=), join)
import Prelude (class Category, class Semigroupoid, ap, compose, const, flip, identity, ($), (<<<), (>>>))
